require 'reform_one_two_six/form/active_model/model_validations'

module ReformOneTwoSix::Form::ActiveModel
  ...
  private
    def active_model_name_for(string)
      return ::ActiveModel::Name.new(OpenStruct.new(:name => string)) if ReformOneTwoSix.rails3_0?
