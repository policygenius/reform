module ReformOneTwoSix::Form::ActiveRecord
  def self.included(base)
    base.class_eval do
      register_feature ReformOneTwoSix::Form::ActiveRecord
  ...
  def model_for_property(name)
    return model unless is_a?(ReformOneTwoSix::Form::Composition) # i am too lazy for proper inheritance. there should be a ActiveRecord::Composition that handles this.
