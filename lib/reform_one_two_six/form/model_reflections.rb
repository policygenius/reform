...
# Goal is to collect all methods and define a reflection API so simple_form works with all ORMs and ReformOneTwoSix
# doesn't have to "guess" what simple_form and other form helpers need.
module ReformOneTwoSix::Form::ModelReflections
  ...
  def defined_enums
    return model.defined_enums unless is_a?(ReformOneTwoSix::Form::Composition)
