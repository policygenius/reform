...
module ReformOneTwoSix::Form::Validate
  module Populator
  ...
  def validate(params)
    ...
    raise DeserializeError.new("[ReformOneTwoSix] Deserialize error: You probably called #validate without setting up your nested models. Check https://github.com/apotonick/reform#populating-forms-for-validation on how to use populators.")
  end
...
private
  ...
  # A lot of this code is simply renaming from ReformOneTwoSix's API to representable's. # FIXME: unify that?
