...
class ReformOneTwoSix::Contract::Errors < ActiveModel::Errors
  def messages
    return super unless ReformOneTwoSix.rails3_0?
    self
  end
  ...
  def merge!(errors, prefix)
    ...
    errors.messages.each do |field, msgs|
      ...
      msgs = [msgs] if ReformOneTwoSix.rails3_0? # DISCUSS: fix in #each?
