...
require 'reform_one_two_six/version'

Gem::Specification.new do |spec|
  spec.name          = "reform_one_two_six"
  spec.version       = ReformOneTwoSix::VERSION
  ...
  spec.homepage      = "https://github.com/policygenius/reform_one_two_six"
  spec.license       = "MIT"
