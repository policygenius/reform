...
class ValidateTest < BaseTest
  describe "populated" do
    ...
    it { subject.hit.must_be_kind_of ReformOneTwoSix::Form }
    it { subject.hit.title.must_equal "Roxanne" }

    it { subject.songs.must_be_kind_of Array }
    it { subject.songs.size.must_equal 2 }

    it { subject.songs[0].must_be_kind_of ReformOneTwoSix::Form }
    it { subject.songs[0].title.must_equal "Fallout" }

    it { subject.songs[1].must_be_kind_of ReformOneTwoSix::Form }
  ...
  describe "not populated properly raises error" do
    it do
      assert_raises ReformOneTwoSix::Form::Validate::DeserializeError do
  ...
  # not sure if we should catch that in ReformOneTwoSix or rather do that in disposable. this is https://github.com/apotonick/reform/pull/104
  ...
  describe "with empty collection and cardinality" do
    ...
    subject { Class.new(ReformOneTwoSix::Form) do
